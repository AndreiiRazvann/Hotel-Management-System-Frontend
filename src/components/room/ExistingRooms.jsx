...
//make use of RoomFilter And RoomPaginator, display, filter and PAGINATE the components
const ExistingRooms = () => {
  ...
  //create the functions. nr.1: get all rooms from DB
  ...
  //when a number is clicked, current page is set to pg number
  ...
  //function to help us calculate the num of pages
